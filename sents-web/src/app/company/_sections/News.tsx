  ...
  return (
    <div className="flex flex-col gap-4">
      {mockData.map(newsItem => (
        <div
          key={newsItem.id}
          className="flex items-center gap-4 bg-white h-auto hover:bg-gray-100 cursor-pointer rounded-2xl"
        ...
        >
          ...
          <div>
            <span className="bg-green-200 text-green-600 p-[3px]">News</span>
